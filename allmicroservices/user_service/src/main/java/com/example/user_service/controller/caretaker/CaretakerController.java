...
public class CaretakerController {
    ...
    public ResponseEntity<PatientRequestResponse> delPatientReq(@NotNull
                                                                @NotBlank
                                                                @RequestParam(name = "cId") String cId, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            return new ResponseEntity<>(new PatientRequestResponse(Messages.FAILED,
    ...
    public ResponseEntity<String> notifyUserForMed(@NotNull
                                                   ...
                                                   @NotBlank
                                                   @RequestParam("medname") String body, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
    ...
    public ResponseEntity<PatientResponse> getPatientRequestsC(@NotNull
                                                               @NotBlank
    ...
    public ResponseEntity<PatientResponse> getPatientsUnderMe(@RequestParam(name = "caretakerId")
                                                              @NotNull
                                                              @Size(max = 5)
